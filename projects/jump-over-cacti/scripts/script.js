...
class MsgHowToJump extends Element {
  ...
  setDeviceSpecificMsg() {
    ...
    this.msgHowToJump.innerHTML =
      '<strong>Press SPACE</strong> or <br><strong>Tap the Screen</strong> <br>To Jump';
  }
}
...
class Cloud extends Element {
  constructor(
    elementClass,
    toPositionOffScreenLeftClass,
    positionOffScreenRightClass,
    positionGameplayClass,
  ) {
...
class Cactus {
  ...
  detectCollision(element) {
    ...
    const distancePlayerCactus = Math.sqrt(
      Math.pow(distancePlayerCactusX, 2) + Math.pow(distancePlayerCactusY, 2),
    );
...
const cloudTop = new Cloud(
  '.cloud-top',
  'cloud-top-to-position-off-screen-left',
  'cloud-top-position-off-screen-right',
  'cloud-top-position-gameplay',
);
const cloudCenter = new Cloud(
  '.cloud-center',
  'cloud-center-to-position-off-screen-left',
  'cloud-center-position-off-screen-right',
  'cloud-center-position-gameplay',
);
const cloudBottom = new Cloud(
  '.cloud-bottom',
  'cloud-bottom-to-position-off-screen-left',
  'cloud-bottom-position-off-screen-right',
  'cloud-bottom-position-gameplay',
);
...
const playerShadow = new Player(
  '.player-shadow',
  'player-shadow-resize',
  'player-shadow-position-gameplay',
);
