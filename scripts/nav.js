...
class Nav extends HeaderElement {
  ...
  clickSmallScreen(e) {
    if (
      e.target.classList.contains('link-logo') ||
  ...
  clickLargeScreen(e) {
    if (e.target.classList.contains('btn-toggle-nav')) {
      ...
      (e.target.classList.contains('link-logo') && window.outerWidth >= 768) ||
...
const btnToggleNavLineTop = new Line(
  '.btn-toggle-nav-line-top',
  'btn-toggle-nav-line-top-expanded',
);
const btnToggleNavLineCenter = new Line(
  '.btn-toggle-nav-line-center',
  'btn-toggle-nav-line-center-expanded',
);
const btnToggleNavLineBottom = new Line(
  '.btn-toggle-nav-line-bottom',
  'btn-toggle-nav-line-bottom-expanded',
);
