...
class PageBody {
  ...
  disableRightClick() {
    ...
    imgsDisabledRightClick.forEach((imgDisabledRightClick) =>
      imgDisabledRightClick.addEventListener('contextmenu', (e) => e.preventDefault()),
    );
  }
}
...
const devicesMidScreen = new SectionProjectsElement(
  '.devices-lg',
  'devices-lg-on-screen',
  'transition-devices',
);
const devices = new SectionProjectsElement(
  '.devices-xl',
  'devices-xl-on-screen',
  'transition-devices',
);

const headingSectionProjects = new SectionProjectsElement(
  '.section-projects-h2-wrapper',
  'pos-section-projects-h2-on-screen',
  'transition-section-projects-h2',
);
const projectsList = new SectionProjectsElement(
  '.projects',
  'pos-projects-on-screen',
  'transition-projects',
);
const btnBackToProjects = new SectionProjectsElement(
  '.btn-back-to-projects',
  'pos-btn-back-to-projects-on-screen',
  'transition-btn-back-to-projects',
);
...
const projectsExceptPeterRomanPortfolio = new Projects(
  '.project:not(.project-peter-roman-portfolio)',
);
const projectsExceptSustainaryMainWebsite = new Projects(
  '.project:not(.project-sustainary-main-website)',
);
...
const projectsExceptTalentFriendlyNation = new Projects(
  '.project:not(.project-talent-friendly-nation)',
);
const projectsExceptSustainableInnovationCamp = new Projects(
  '.project:not(.project-sustainable-innovation-camp)',
);
...
const projectDetailsPolyglotGathering = new SectionProjectsElement(
  '.project-details-polyglot-gathering',
);
...
const projectDetailsPeterRomanPortfolio = new SectionProjectsElement(
  '.project-details-peter-roman-portfolio',
);
const projectDetailsSustainaryMainWebsite = new SectionProjectsElement(
  '.project-details-sustainary-main-website',
);
...
const projectDetailsTalentFriendlyNation = new SectionProjectsElement(
  '.project-details-talent-friendly-nation',
);
const projectDetailsSustainableInnovationCamp = new SectionProjectsElement(
  '.project-details-sustainable-innovation-camp',
);
...
document.addEventListener('transitionstart', (e) => {
  if (e.target.classList.contains('devices-xl') || e.target.classList.contains('devices-lg')) {
